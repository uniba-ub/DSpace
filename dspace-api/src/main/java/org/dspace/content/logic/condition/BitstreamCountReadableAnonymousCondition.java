 ...
 * @version $Revision$
 */
public class BitstreamCountReadableAnonymousCondition extends AbstractCondition {
    /**
    ...
    public Boolean getResult(Context context, Item item) throws LogicalStatementException {
        ...
        for (Bundle bundle : bundles) {
            ...
            boolean bundlevisible = bundle.getResourcePolicies().stream()
            ...
            if (bundlevisible) {
                ...
                for (Bitstream bitstream : bitstreams) {
                    boolean bitstreamvisible = bitstream.getResourcePolicies().stream()
                            .filter(policy -> policy.getGroup() != null)
