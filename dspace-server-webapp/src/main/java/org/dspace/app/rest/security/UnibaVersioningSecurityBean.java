 ...
 */
@Component(value = "unibaVersioningSecurity")
public class UnibaVersioningSecurityBean {
    ...
    public boolean isEnableVersioning() {
        return configurationService.getBooleanProperty("versioning.uniba.enabled", true);
    }
